...
// Mock imports
import { GHSTOFT } from "../../contracts/GHSTOFT.sol";
...
contract MyOFTTest is TestHelperOz5 {
    ...
    function setUp() public virtual override {
        ...
        aOFT = GHSTOFT(
            _deployOApp(type(GHSTOFT).creationCode, abi.encode("aOFT", "aOFT", address(endpoints[aEid]), address(this)))
        );

        bOFT = GHSTOFT(
            _deployOApp(type(GHSTOFT).creationCode, abi.encode("bOFT", "bOFT", address(endpoints[bEid]), address(this)))
        );
